%% SSA 真实数据集测试脚本
% 使用SSA（Singular Spectrum Analysis）方法对真实数据集进行EOG伪影去除
% 输出统一格式的.mat文件
...
% 结果保存路径
RESULTS_DIR = 'results';
PREDICTION_SAVE_PATH = fullfile(RESULTS_DIR, 'SSA_real_data_predictions.mat');

% 总结果保存路径
FINAL_RESULTS_DIR = fullfile('..', '..', '..', 'results');
FINAL_PREDICTION_PATH = fullfile(FINAL_RESULTS_DIR, 'SSA_real_data_predictions.mat');
