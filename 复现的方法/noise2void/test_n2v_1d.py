...
from data_config import TEST_CONTAMINATED_PATH, TEST_PURE_PATH, DATA_KEY, SAMPLING_RATE, PREDICTION_SAVE_PATH
...
def main():
    ...
    # 加载训练好的权重（使用相对路径）
    model_path = f'checkpoints/N2V_1D_{DATASET_NAME}_best.pth'
